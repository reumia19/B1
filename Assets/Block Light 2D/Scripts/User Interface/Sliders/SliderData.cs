...
{
    [SerializeField]
    protected List<float> sliderData;
    ...
    public enum SliderField
    {
        ...
        // Lighting
        LIGHTING_PENETRATION = ENUM_INTERVAL * 3,
        LIGHTING_PENETRATION_BACK,
        LIGHTING_BACK_SHADOW,
        LIGHTING_ITERATION,

        // Day/night cycle
        CYCLE_SPEED = ENUM_INTERVAL * 4,
        CYCLE_INTERVAL,
        CYCLE_SPAN,
        DAWN_SPAN,
        DAWN_FOCUS_POINT,
        ...
        PERFORMANCE_MS_MAX = ENUM_INTERVAL * 5
    }
